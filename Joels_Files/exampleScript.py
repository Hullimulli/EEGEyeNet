from AnalEyeZor import AnalEyeZor
import numpy as np
import pandas as pd
...
def main():
    ...
    if trainModels:
        ...
        experimentOne = AnalEyeZor(task="Direction", dataset="dots", preprocessing="min", trainBool=True
                                   ,models=["PyramidalCNN"])
        ...
        experimentOne = AnalEyeZor(task="Direction", dataset="dots", preprocessing="min", trainBool=False
                                   ,models=["PyramidalCNN"],path="Sample_Direction_PyramidalCNN_PFI/")

    #PFI Analysis for the angle task.
    if calculatePFI:
    ...
    if trainModels:
        ...
        experimentTwo = AnalEyeZor(task="Direction", dataset="dots", preprocessing="min", trainBool=True
        ...
        experimentTwo = AnalEyeZor(task="Direction", dataset="dots", preprocessing="min", trainBool=False
    ...
    if trainModels:
        ...
        experimentThree = AnalEyeZor(task="Direction", dataset="dots", preprocessing="min", trainBool=True
        ...
        experimentThree = AnalEyeZor(task="Direction", dataset="dots", preprocessing="min", trainBool=False

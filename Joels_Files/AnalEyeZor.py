...
class AnalEyeZor():
    ...
    def findDataPoints(self, type = "UpToDown", yValue = 0, minimalStrength = 0,electrode = 32, scale=False,
        ...
        @param type: Type of the signal corresponding to the data indices. Can be "UpToDown", "DownToUp", "Missclassified", "UpAndDown", "LeftOnly", "RightOnly", "UpOnly", "DownOnly".
        @type type: String
        ...
        @type dimensions: Integer
        @param model: Model of which the corresponding file generated by the predictAll function is used. Used in "Missclassified", "UpAndDown", "LeftOnly", "RightOnly", "UpOnly", "DownOnly".
        @type model: String
        @param run: The run of the model. Used in "Missclassified", "UpAndDown", "LeftOnly", "RightOnly", "UpOnly", "DownOnly".
        @type run: Integer
        @param postfix: The postfix of the predictAll generated filename. Used in "Missclassified". Used in "Missclassified", "UpAndDown", "LeftOnly", "RightOnly", "UpOnly", "DownOnly".
        @type postfix: String
        @param lossThresh: The minimal loss which has to be present in order to return the index. Used in "Missclassified", "UpAndDown", "LeftOnly", "RightOnly", "UpOnly", "DownOnly".
        @type lossThresh: float
        @param returnAngleBool: If True, the angular task is loaded. Used in "Missclassified".

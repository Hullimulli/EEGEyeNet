...
class EEGNet(BaseNet):
    ...
    def __init__(self, model_name, path, loss, model_number, batch_size, input_shape, output_shape, epochs=50,
        ...
        super().__init__(model_name=model_name, path=path, loss=loss, input_shape=input_shape, output_shape=output_shape, epochs=epochs, 
                            model_number=model_number, verbose=verbose)

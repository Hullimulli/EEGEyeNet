...
#task = method(name='CNN_1D',directory='/Users/Hullimulli/Documents/ETH/SA2/localRuns', seed=args.seed, convDimension=12, wandbProject='',batchSize=32, task='angle')
task.fit(nrOfEpochs=25, saveBool=False)